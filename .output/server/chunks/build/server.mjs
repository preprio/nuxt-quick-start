import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { isRef, reactive, unref, hasInjectionContext, getCurrentInstance, ref, customRef, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, computed, toValue, onServerPrefetch, inject, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, createVNode, resolveDynamicComponent, effectScope, nextTick, toRef, defineAsyncComponent, mergeProps, getCurrentScope, withCtx, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { p as parseURL, e as encodePath, l as decodePath, m as hasProtocol, n as isScriptProtocol, i as joinURL, w as withQuery, o as hash, s as sanitizeStatusCode, q as getContext, r as klona, t as parse, v as getRequestHeader, x as isEqual, y as setCookie, z as getCookie, A as deleteCookie, $ as $fetch, B as defu, c as createError$1, C as executeAsync, D as getRequestHeaders } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    component: () => import('./_slug_-_vbzua08.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DT2GSf-Y.mjs')
  }
];
...
function shouldInclude(_a2, variables) {
  ...
  return getInclusionDirectives(directives).every(function(_a22) {
...
function getInclusionDirectives(directives) {
  ...
  if (directives && directives.length) {
    directives.forEach(function(directive) {
      ...
      invariant(ifValue && (ifValue.kind === "Variable" || ifValue.kind === "BooleanValue"), 108, directiveName);
...
function getFragmentMaskMode(fragment) {
  var _a2, _b;
  var directive = (_a2 = fragment.directives) === null || _a2 === void 0 ? void 0 : _a2.find(function(_a22) {
    var name = _a22.name;
  ...
  var modeArg = (_b = directive.arguments) === null || _b === void 0 ? void 0 : _b.find(function(_a22) {
    var name = _a22.name;
...
function readMultipartBody(response, nextValue) {
  return __awaiter(this, void 0, void 0, function() {
    var decoder, contentType, delimiter, boundaryVal, boundary, buffer, iterator, running, _a2, value, done, chunk, searchFrom, bi, message, i, headers, contentType_1, body, result, next;
    var _b, _c;
    var _d;
...
var createHttpLink = function(linkOptions) {
  ...
  return new ApolloLink(function(operation) {
    ...
    if (context.clientAwareness) {
      var _a22 = context.clientAwareness, name_1 = _a22.name, version2 = _a22.version;
      if (name_1) {
        ...
        if (isField(selection)) {
          ...
          if (fieldValue === void 0) {
            if (!addTypenameToDocument.added(selection)) {
              missing = missingMerger.merge(missing, (_a22 = {}, _a22[resultName] = "Can't find field '".concat(selection.name.value, "' on ").concat(isReference(objectOrReference) ? objectOrReference.__ref + " object" : "object " + JSON.stringify(objectOrReference, null, 2)), _a22));
            }
    ...
    StoreReader2.prototype.execSubSelectedArrayImpl = function(_a2) {
      ...
      function handleMissing(childResult, i) {
        ...
        if (childResult.missing) {
          missing = missingMerger.merge(missing, (_a22 = {}, _a22[i] = childResult.missing, _a22));
        }
...
var StoreWriter = (
  ...
  (function() {
    ...
    StoreWriter2.prototype.writeToStore = function(store, _a2) {
      ...
      context.incomingById.forEach(function(_a22, dataId2) {
    ...
    StoreWriter2.prototype.processSelectionSet = function(_a2) {
      ...
      this.flattenFields(
        ...
        if (value !== void 0) {
          ...
          incoming = context2.merge(incoming, (_a22 = {}, _a22[storeFieldName] = incomingValue, _a22));
    ...
    ObservableQuery2.prototype.updatePolling = function() {
      ...
      var maybeFetch = function() {
        ...
        if (_this.pollingInfo) {
          if (!isNetworkRequestInFlight(_this.queryInfo.networkStatus) && !((_b = (_a22 = _this.options).skipPollAttempt) === null || _b === void 0 ? void 0 : _b.call(_a22))) {
            _this.reobserve({
  ...
  (function() {
    ...
    QueryInfo2.prototype.setDiff = function(diff) {
      ...
      if (diff && !diff.complete && muteDeprecations("getLastError", function() {
        var _a22;
        return (_a22 = _this.observableQuery) === null || _a22 === void 0 ? void 0 : _a22.getLastError();
      })) {
        return;
      }
    ...
    QueryManager2.prototype.refetchQueries = function(_a2) {
      ...
      if (includedQueriesById.size) {
        includedQueriesById.forEach(function(_a22, queryId) {
          var oq = _a22.oq, lastDiff = _a22.lastDiff, diff = _a22.diff;
          var result;
          if (onQueryUpdated) {
            if (!diff) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a2) {
          ...
          return [2, resultPromise.then(function(result) {
            ...
            var isClientField = (_b = (_a22 = field.directives) === null || _a22 === void 0 ? void 0 : _a22.some(function(d) {
...
var ApolloClients = /* @__PURE__ */ Symbol("apollo-clients");
({
  queries: ref(0),
  mutations: ref(0),
  subscriptions: ref(0)
...
const NuxtApollo = {
  ...
  clients: { "prepr": { "httpEndpoint": "https://graphql.prepr.io/graphql", "defaultOptions": {}, "inMemoryCacheOptions": {}, "tokenName": "apollo:prepr.token", "tokenStorage": "cookie", "authType": "Bearer", "authHeader": "Authorization", "httpLinkOptions": { "headers": { "Authorization": "Bearer ac_e54beab08406dd41fcdead2bef10364f442559f67fe86ebb0ac7aa6e3a1a4605" } } } }
};
...
defineComponent({
  ...
  setup(props, { slots, attrs }) {
    ...
    return () => {
      ...
      const slot2 = slots.fallback || slots.placeholder;
      if (slot2) {
        return h(slot2);
      }
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CWI5346b.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BOgfxjmb.mjs'));
...
export { _export_sfc as _, useAsyncQuery as a, useRouter as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, navigateTo as n, resolveRouteObject as r, useNuxtApp as u };
